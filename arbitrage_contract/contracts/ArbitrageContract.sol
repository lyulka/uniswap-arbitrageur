...
contract ArbitrageContract {
    ...
    /// @param fee0 The amount of token0 that we have to pay back to the pair contract at the end of this call.
    /// @param fee1 The amount of token1 that we have to pay back to the pair contract at the end of this call.
    /// @param data The `arbitrageRequest` bytes vector initially passed to the `arbitrage` method.
